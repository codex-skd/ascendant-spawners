...
public class SpawnerModifier implements Recipe<RecipeInput> {
     ...
     */
    public boolean matches(AscendantSpawnerTile tile, ItemStack mainhand, ItemStack offhand) {
     ...
     */
    public boolean apply(AscendantSpawnerTile tile) {
    ...
    @Nullable
    public static SpawnerModifier findMatch(AscendantSpawnerTile tile, ItemStack mainhand, ItemStack offhand) {
        return tile.getLevel().getRecipeManager().getAllRecipesFor(AscSpObjects.SPAWNER_MODIFIER.get())
            .stream()
