...
public class SpawnerStats {
    ...
    public static final Registry<SpawnerStat<?>> REGISTRY = new RegistryBuilder<SpawnerStat<?>>(ResourceKey.createRegistryKey(AscendantSpawners.loc("spawner_stat"))).create();
    ...
    public static void generateTooltip(AscendantSpawnerTile tile, Consumer<Component> list) {
