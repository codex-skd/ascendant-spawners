...
import com.skd.ascendantspawners.block.AscendantSpawnerTile.SpawnerLogicExt;
...
public class ModifierTrigger extends SimpleCriterionTrigger<ModifierTrigger.TriggerInstance> {
    ...
    public void trigger(ServerPlayer player, AscendantSpawnerTile tile, SpawnerModifier modif) {
    ...
    public static record TriggerInstance(Optional<ContextAwarePredicate> player, Ints minDelay, Ints maxDelay, Ints spawnCount, Ints nearbyEnts,
        ...
        public boolean test(ServerPlayer player, AscendantSpawnerTile tile, SpawnerModifier modif) {
        ...
        private <T> boolean check(AscendantSpawnerTile tile, SpawnerStat<T> stat, Optional<T> target) {
