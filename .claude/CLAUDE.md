...
1. **Trabaja con `docs/WORKFLOW_ASCENDANT_SPAWNERS_26-2.md`** — es el workflow operativo de este mod, autocontenido. Léelo y síguelo. No hay que actualizarlo por sesión.
...
3. Workflow del proyecto (`docs/WORKFLOW_ASCENDANT_SPAWNERS_26-2.md`).
